...
shader_prog blinnPhong("shaders/phong.vert.glsl", "shaders/blinn_phong.frag.glsl");
//active shader
...
void initChopper() {
    ...
    bodyVAO = createSphere(1.0f, 38, 36, glm::vec3(1.0, 0.0, 0.0), chopperBodyTriangleCount); //createCube(glm::vec3(0.4, 0.4, 0.4), glm::vec3(0.9, 0.9, 0.9));
